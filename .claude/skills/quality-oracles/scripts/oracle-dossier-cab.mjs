#!/usr/bin/env node
// oracle-dossier-cab — Domaine « Dossier CAB (DOCX, template Nhood) ».
...
//   C9 charte : les titres portent la couleur Nhood (77C043) en mise en forme directe — les styles
...
const DOM = 'Dossier CAB (DOCX, template Nhood)';
const NJ = [

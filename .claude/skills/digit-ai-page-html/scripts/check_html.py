...
def check_charte(html: str):
    ...
    # TF-0228 (lot SCC_ALX, 14/08) — cet avertissement frappait le script que le pattern S-G1
    ...
    #
    # RECONSTAT RA-11 / TF-0368 (lot SCC_ALX 20260818a, 18/08) — et il INFIRME à moitié ce qui
...
def check_lisibilite(html: str, a: Arbre):
    ...
    for jeton, (n, ou) in list(vus_f.items())[:6]:
        ...
        # l'aller-retour de diagnostic constaté sur le livrable SCC_ALX.
    ...
    def bareme_de_colonne(n):
        """RA-4 (retour SCC_ALX, 13/08) : quand toute une COLONNE partage le même barème
    ...
    def bareme_de_groupe(n):
        """TF-0231 (reconstat de TF-0170, lot SCC_ALX du 14/08) — ARBITRAGE.
    ...
    if tables_longues:
        ...
        # TF-0229 (lot SCC_ALX, 14/08) — le message PROMETTAIT une porte que le code n'ouvrait
    ...
    # --- L14 : plomberie affichée (TF-0227, lot SCC_ALX du 14/08) ----------
...
def check_autonomie(html: str):
    ...
    # A1-bis (RA-1, retour SCC_ALX du 13/08) : une séquence </script> écrite en clair dans le
...
# TF-0366 (lot SCC_ALX 20260818a, 18/08) — un verdict archivé ne disait pas sous quel JEU DE

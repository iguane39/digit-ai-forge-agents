...
**Quelle que soit la propriété (TF-0421, lot Hoopiz 20260820a).** `width: min(75ch, 100%)`
...
**Un chapeau est une phrase ÉCRITE, jamais générée (TF-0423, lot Hoopiz 20260820a).** Douze
...
**Trace attendue — OBLIGATOIRE (TF-0422, lot Hoopiz 20260820a)** : la revue de lecture se
...
défaut fondateur (14/08, rapport SCC_ALX) : un livrable **diffusé** portait 71 occurrences de
...
(TF-0435, lot Hoopiz 20260820b) : la pile de repli mono n'a pas ce caractère ; seul l'œil

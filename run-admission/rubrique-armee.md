...
## Contrat de sortie (armement oracle-judge — 24/07/2026, la rubrique ci-dessus fait foi)

Le LIVRABLE À ÉVALUER est un dossier A/B : demande témoin, baseline (A), contribution (B).
Appliquer les 5 axes et la règle de décision ci-dessus à la comparaison A vs B.
Répondre UNIQUEMENT en JSON : {"verdict":"PASS|FAIL","scores":{"axe1_actionnable":"OUI|NON","axe2_ancrage":"OUI|NON","axe3_specificite":"OUI|NON","axe4_non_transposable":"OUI|NON","axe5_consequence":"OUI|NON","verdict_rubrique":"MATERIEL|NON_MATERIEL"},"findings":[{"sev":"warn","msg":"citation ou raison par axe","where":"axe concerné"}]}
PASS = MATERIEL (règle de décision : axes 1, 2 et 4 OUI, et au moins un des axes 3 ou 5 OUI). FAIL = NON_MATERIEL. En cas de doute sur l'axe 4, trancher NON — le doute profite à la baseline. Maximum 5 findings.
